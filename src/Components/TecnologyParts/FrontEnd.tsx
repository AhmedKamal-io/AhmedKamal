...
const FrontEnd = () => {
  return (
    <div className="bg-[url(/Image/dark-background1.png)] bg-cover bg-center p-6 rounded-2xl h-[480px] Bigshadow w-[350px] border-2 border-Whitey transform hover:scale-105 duration-500">
      ...
      <ul className="flex flex-col gap-1.5 text-2xl font-light ">
        <li className="flex items-center gap-2 bg-BlackyFade p-1 hover:shadow-[#0081A3] hover:shadow-lg rounded-lg hover:bg-Blacky transition-all duration-500 my-1">
          <span className="hover:text-[#0081A3] transition-all duration-500 bg-Blacky hover:bg-Blacky p-3 rounded-4xl transform hover:scale-110  text-4xl">
            <SiReact />
          </span>
          React
        </li>
        ...
        <li className="flex items-center gap-2 bg-BlackyFade p-1 hover:shadow-[#38B2AC] hover:shadow-lg rounded-lg hover:bg-Blacky transition-all duration-500 my-1">
          <span className="hover:text-[#38B2AC] transition-all duration-500 bg-Blacky hover:bg-Blacky p-3 rounded-full transform hover:scale-110 text-4xl">
            <SiTailwindcss />
          </span>
